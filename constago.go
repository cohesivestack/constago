...
func newRootCmd(run func(*constago.Config) error) *cobra.Command {
	...
	cmd.Flags().String("input.struct.only", "", "Regular expression to include structs (whitelist)")
	cmd.Flags().String("input.struct.except", "", "Regular expression to exclude structs (blacklist)")
	...
	cmd.Flags().String("input.field.only", "", "Regular expression to include fields (whitelist)")
	cmd.Flags().String("input.field.except", "", "Regular expression to exclude fields (blacklist)")
